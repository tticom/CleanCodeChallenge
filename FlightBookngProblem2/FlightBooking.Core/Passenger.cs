...
namespace FlightBooking.Core
{
    ...
    public class LoyaltyPassenger: ILoyaltyPassenger
    {
    ...
    public class GeneralPassenger : IGeneralPassenger
    {
        public string Name { get; set; }
        public int Age { get; set; }
        public int AllowedBags { get; set; }
    ...
    public class AirlineEmployee : IAirlineEmployee 
    {
        public string Name { get; set; }
        public int Age { get; set; }
        public int AllowedBags { get; set; }
    ...
    public class DiscountPassenger : IDiscounted
    {
        public string Name { get; set; }
        public int Age { get; set; }
