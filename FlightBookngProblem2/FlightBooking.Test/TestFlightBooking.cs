...
namespace FlightBooking.Test
{
    public class TestFlightBooking : FlightBookingTestBase
    {
        ...
        public void Test_AllDiscounted_Report()
        {
            ...
            var expected = "FLIGHTMAYNOTPROCEEDOthermoresuitableaircraftare:ATR640couldhandlethisflightBombardierQ400couldhandlethisflight".Replace(" ", "");
            SetupOriginalAllFlightData();
            AddAllDiscountedPassegers();
            var report = Regex.Replace(TestFlight.GetSummary(), @"\s", "");
            Assert.Equal(expected, report);
    ...
    public class FlightBookingTestBase : IDisposable
    {
        ...
        protected AircraftFactory AircraftFactoryMethod => AircraftFactory.FactoryMethod();
        protected Plane Antonovsky => new Plane { Id = 123, Name = "Antonov AN-2", NumberOfSeats = 12 };
        protected Plane ATR => new Plane { Id = 456, Name = "ATR 640", NumberOfSeats = 44 };
        protected Plane Q400 => new Plane { Id = 789, Name = "Bombardier Q400", NumberOfSeats = 76 };
